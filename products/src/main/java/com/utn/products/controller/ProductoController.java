...
@Tag(name = "Aplicación de Gestión de Productos.")
public class ProductoController {
    ...
    @Operation(summary = "Obtener un producto por su numero identificador")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Obtener los productos ordenados por categoría.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Lista filtrada correctamente."),
            @ApiResponse(responseCode = "400", description = "No existe producto en esta categoria.")
    })
    ...
    @Operation(summary = "Actualizar un producto por su numero de identificación")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Actualizar stock de producto por ID")
    @ApiResponses(value = {
